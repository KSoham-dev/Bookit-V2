      ...
      <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="row whitebg">
          ...
          <div class="col-6 rightside d-flex justify-content-center align-items-center">
            <div class="role">
              <a href="/" style="font-weight: 100;">User</a> | <a href="/lib/login">Librarian</a>
            </div>
            <div class="login">
              <header class="display-6"> Login </header>
              <form autocomplete="off" method="POST" @submit.prevent="libLogin">
...
methods:{
    libLogin(ev){
      ...
      fetch('http://127.0.0.1:5000/auth/lib/login', {
        method: 'POST',
        headers: {
